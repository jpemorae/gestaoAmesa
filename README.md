...
## V38 - Sessão persistente no navegador

Correção:
- Ao fazer login, o usuário fica salvo no localStorage.
- Ao atualizar a página, o sistema mantém o usuário logado.
- A última tela acessada também é preservada.
- Ao sair, a sessão é limpa corretamente.
